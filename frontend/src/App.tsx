      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route path="/" element={<MainLayout />}>
            ...
            <Route
              path="mutual-fund/:id"
              element={<Navigate to="/mutual-funds/details/:id" replace />}
            />
            ...
            <Route
              path="insights"
              element={<Navigate to="/stocks/insights" replace />}
            />
            <Route
              path="watchlist"
              element={<Navigate to="/stocks/watchlist" replace />}
            />
            <Route
              path="stock/:ticker"
              element={<Navigate to="/stocks/details/:ticker" replace />}
            />
          </Route>
