...
export function Notifications() {
  ...
  const { notifications, fetchNotifications, markAsRead, loading } =
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      <header className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-black text-text-bold tracking-tight">
            Notifications
          </h1>
      ...
      {loading && notifications.length === 0 ? (
        ...
        <div className="text-center py-24 bg-white/[0.02] border border-white/5 rounded-[2rem] border-dashed">
          ...
          <h2 className="text-xl font-black text-text-bold tracking-tight">
            System Silent
          </h2>
